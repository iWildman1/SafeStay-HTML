...
var bookingForm = require('./modules/booking-form');
var relocations = require('./modules/redirections');
...
},{"./modules/booking-form":5,"./modules/carousels":6,"./modules/menus":7,"./modules/redirections":8,"jquery":2}],5:[function(require,module,exports){
'use strict';
...
},{"flatpickr":1}],6:[function(require,module,exports){
'use strict';
...
function initExploreCarousel() {
    ...
    var x = 0;
    var curOffset = 0;
    var inDragExplore = false;

    var slider = $('.explore-slider');
    var slides = slider.children();

    var sliderControlCode = '<div class="control"></div>';
    var output = "";
    ...
    $(document).mouseup(function () {
        ...
        if (inDragExplore) {
            ...
            var closestElementOffset = 0;
            var closestElement = void 0;
            var closestElementIndex = 0;

            slides.each(function (i) {

                var xoffset = parseInt(slider.css('transform').split(',')[4]);

                var pos = $(this).position().left + xoffset;
            ...
            var controls = $('.slider-controls').children();
...
},{"velocity-animate/velocity.js":3}],7:[function(require,module,exports){
'use strict';
...
function initLocationsMenu() {
    ...
    $('.locations-close-toggle').click(function () {
        $('.locations-overlay-1').velocity({
            translateX: ['-100%', '0%']
        }, 400);
    });
...
},{"velocity-animate/velocity.js":3}],8:[function(require,module,exports){
"use strict";

function initBookingFormRelocation() {
    $('.relocate-group-booking').click(function () {
